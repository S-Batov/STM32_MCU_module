...
uint16_t sendCmdUCC5870(uint16_t tx_data)
{
	...
	HAL_GPIO_WritePin(SPI1_CS_Driver_GPIO_Port,
						SPI1_CS_Driver_Pin,
						GPIO_PIN_RESET);
	HAL_StatusTypeDef status = SPI_TransmitReceive_Driver((uint8_t*) &tx_data,
															(uint8_t*) &rx_data,
															1,
															HAL_MAX_DELAY);
	if (status != HAL_OK) {
		// Handle error (e.g., toggle an LED, print debug message)
	}
	HAL_GPIO_WritePin(SPI1_CS_Driver_GPIO_Port,
						SPI1_CS_Driver_Pin,
						GPIO_PIN_SET);
...
void Init_UCC5870_Regs(void) {
	...
	//
	ucc5870[UL].cfg1.bit.GD_TWN_DIS = OT_warning_enable;
	ucc5870[UL].cfg1.bit.IO_DEGLITCH = io_deglitch_210ns;
	ucc5870[UL].cfg1.bit.NFLT2_DOUT_MUX = nFLT2_DOUT_nFLT2;
	ucc5870[UL].cfg1.bit.OV1_DIS = vcc1_ovlo_enable;
	ucc5870[UL].cfg1.bit.UV1_DIS = vcc1_uvlo_enable;
	ucc5870[UL].cfg1.bit.OVLO1_LEVEL = vcc1_3V3;
	ucc5870[UL].cfg1.bit.UVLO1_LEVEL = vcc1_3V3;
	ucc5870[UL].cfg1.bit.TDEAD = Tdead(0);  // in ns

	//
	// CFG2 register settings
	//
	ucc5870[UL].cfg2.bit.PWM_CHK_FAULT = report_fault_on_nFLT1; //  PWM check fault
	ucc5870[UL].cfg2.bit.VREG1_ILIMIT_FAULT = report_fault_on_nFLT1; //  Vreg Ilimit fault
	ucc5870[UL].cfg2.bit.GD_TWN_FAULT = warning_on_nFLT1; //  temp warning fault
	ucc5870[UL].cfg2.bit.BIST_FAULT = report_fault_on_nFLT1; //  Analog BIST fault
	ucc5870[UL].cfg2.bit.TRIM_CRC_FAULT = report_fault_on_nFLT1;   //  CRC fault
	ucc5870[UL].cfg2.bit.INT_REG_FAULT = report_fault_on_nFLT1; //  Internal regulator fault
	ucc5870[UL].cfg2.bit.CFG_CRC_FAULT = report_fault_on_nFLT1; //  reg CRC fault
	ucc5870[UL].cfg2.bit.SPI_FAULT = dont_report_SPI_fault; //report_SPI_fault_on_nFLT1;  //  SPI fault
	ucc5870[UL].cfg2.bit.CLK_MON_FAULT = report_fault_on_nFLT1; //  Clock monitor fault
	ucc5870[UL].cfg2.bit.STP_FAULT = report_fault_on_nFLT1;     //  STP fault
	ucc5870[UL].cfg2.bit.UVLO1_FAULT = report_fault_on_nFLT1;     //  UVLO fault
	ucc5870[UL].cfg2.bit.OVLO1_FAULT = report_fault_on_nFLT1;     //  OVLO fault
	ucc5870[UL].cfg2.bit.INT_COMM_FAULT = report_comm_fault_on_nFLT1; //  Inter-die comm failure

	//
	// CFG3 register settings
	//
	ucc5870[UL].cfg3.bit.AI_IZTC_SEL = AI1_AI3_AI5_bias_currents_off; //
	ucc5870[UL].cfg3.bit.FS_STATE_CFG_CRC_FAULT = OUTx_LOW; //
	ucc5870[UL].cfg3.bit.ITO2_EN = CURRENT_SRC_OUT_AI2_4_6_DISABLED; //
	ucc5870[UL].cfg3.bit.ITO1_EN = CURRENT_SRC_OUT_AI1_3_5_DISABLED; //
	ucc5870[UL].cfg3.bit.FS_STATE_INT_COMM_FAULT = OUTx_LOW; //
	ucc5870[UL].cfg3.bit.FS_STATE_INT_REG_FAULT = OUTx_LOW; //
	ucc5870[UL].cfg3.bit.FS_STATE_SPI_FAULT = FS_SPI_OUTx_LOW; //
	ucc5870[UL].cfg3.bit.FS_STATE_STP_FAULT = FS_STP_OUTx_LOW; //
	ucc5870[UL].cfg3.bit.FS_STATE_PWM_CHK = OUTx_LOW; //
	ucc5870[UL].cfg3.bit.FS_STATE_OVLO1_FAULT = OUTx_LOW; //
	ucc5870[UL].cfg3.bit.FS_STATE_UVLO1_FAULT = OUTx_LOW; //

	//
	// CFG4 register settings
	//
	ucc5870[UL].cfg4.bit.UVOV3_EN = VEE2_uvlo_ovlo_enable; //
	ucc5870[UL].cfg4.bit.PS_TSD_EN = Switch_thermal_SD_disable; //
	ucc5870[UL].cfg4.bit.OCP_DIS = OCP_disable; //
	ucc5870[UL].cfg4.bit.SCP_DIS = SCP_disable; //
	ucc5870[UL].cfg4.bit.DESAT_EN = DESAT_det_enable; //DESAT_det_disable; //
	ucc5870[UL].cfg4.bit.VCECLP_EN = VCE_CLAMP_enable; //
	ucc5870[UL].cfg4.bit.MCLP_DIS = MILLER_CLAMP_enable; //
	ucc5870[UL].cfg4.bit.GM_EN = Gate_Volt_Mon_enable;
	ucc5870[UL].cfg4.bit.GM_BLK = Gate_volt_mon_blank_2500ns; //
	ucc5870[UL].cfg4.bit.MCLP_CFG = MILLER_CLAMP_internal; //
	ucc5870[UL].cfg4.bit.OV2_DIS = VCC2_ovlo_enable; //
	ucc5870[UL].cfg4.bit.DESAT_DEGLITCH = DESAT_deglitch_316ns; //
	ucc5870[UL].cfg4.bit.PS_TSD_DEGLITCH = TSD_1000ns; //
	ucc5870[UL].cfg4.bit.UV2_DIS = VCC2_uvlo_enable; //

	//
	// CFG5 register settings
	//
	ucc5870[UL].cfg5.bit.PWM_MUTE_EN = PWM_MUTE_FOR_SC_OC_OT_FAULTS_DISABLED;
	ucc5870[UL].cfg5.bit.TLTOFF_STO_EN = STO_2LTOFF_DISABLED; //STO_FOR_SC_DESAT_OC;
	ucc5870[UL].cfg5.bit.STO_CURR = SOFT_TURN_OFF_1_2A;
	ucc5870[UL].cfg5.bit.MCLPTH = MILLER_CLAMP_VTH_3V;
	ucc5870[UL].cfg5.bit.DESAT_DCHG_EN = DESAT_DISCHARGE_ENABLE; //DESAT_DISCHARGE_DISABLE;
	ucc5870[UL].cfg5.bit.DESAT_CHG_CURR = BLANK_CAP_CHRG_CUR_800uA;
	ucc5870[UL].cfg5.bit.DESATTH = DESAT_VTH_3p5;
	ucc5870[UL].cfg5.bit.GM_STO2LTO_DIS = GATE_MON_FLT_DURING_STO_TLTOFF_ENABLED;

	//
	// CFG6 register settings
	//
	ucc5870[UL].cfg6.bit.PS_TSDTH = TSD_TH_2p75;
	ucc5870[UL].cfg6.bit.TEMP_CURR = TEMP_CURR_0p1A;
	ucc5870[UL].cfg6.bit.OC_BLK = OCD_BLANK_TIME_0p5us;
	ucc5870[UL].cfg6.bit.SC_BLK = SCD_BLANK_TIME_0p2us;
	ucc5870[UL].cfg6.bit.SCTH = SCD_VTH_1p25V;
	ucc5870[UL].cfg6.bit.OCTH = OCD_VTH_0p5V;

	//
	// CFG7 register settings
	//
	ucc5870[UL].cfg7.bit.FS_STATE_ADC_FAULT = FS_ADC_FLT_OUT_IGNORE;
	ucc5870[UL].cfg7.bit.ADC_FAULT_P = dont_report_adcfault_on_nFLT1;
	ucc5870[UL].cfg7.bit.ADC_SAMP_DLY = ADC_SAMP_DELAY_1120ns;
	ucc5870[UL].cfg7.bit.ADC_SAMP_MODE = ADC_SAMP_CENTER_ALIGN;
	ucc5870[UL].cfg7.bit.ADC_EN = ADC_SAMP_DISABLE;
	ucc5870[UL].cfg7.bit.OVLO3TH = VEE2_OVLO_VTH_M10V;
	ucc5870[UL].cfg7.bit.UVLO3TH = VEE2_UVLO_VTH_M3V;
	ucc5870[UL].cfg7.bit.OVLO2TH = VCC2_OVLO_VTH_P23V;
	ucc5870[UL].cfg7.bit.UVLO2TH = VCC2_UVLO_VTH_P12V;

	//
	// CFG8 register settings
	//
	ucc5870[UL].cfg8.bit.IOUT_SEL = GATE_DRIVE_STRENGTH_FULL;
	ucc5870[UL].cfg8.bit.AI_ASC_MUX = AI_ASC_MUX_AI;
	ucc5870[UL].cfg8.bit.VREF_SEL = VREF_INTERNAL;
	ucc5870[UL].cfg8.bit.GD_2LOFF_STO_EN = GD_2LOFF_STO_ENABLE;
	ucc5870[UL].cfg8.bit.CRC_DIS = CRC_CHECK_ENABLE;
	ucc5870[UL].cfg8.bit.GD_2LOFF_CURR = GD_2LOFF_DISCHARGE_CURR_0p9A;
	ucc5870[UL].cfg8.bit.GD_2LOFF_TIME = GD_2LOFF_PLATEAU_TIME_150ns;
	ucc5870[UL].cfg8.bit.GD_2LOFF_VOLT = GD_2LOFF_PLATEAU_VOLT_6V;

	//
	// CFG9 register settings
	//
	ucc5870[UL].cfg9.bit.CLK_MON_SEC_FAULT = report_fault_on_nFLT1;
	ucc5870[UL].cfg9.bit.VREG2_ILIMIT_FAULT = report_fault_on_nFLT1;
	ucc5870[UL].cfg9.bit.BIST_SEC_FAULT = report_fault_on_nFLT1;
	ucc5870[UL].cfg9.bit.INT_REG_SEC_FAULT = report_fault_on_nFLT1;
	ucc5870[UL].cfg9.bit.TRIM_CRC_SEC_FAULT = report_fault_on_nFLT1;
	ucc5870[UL].cfg9.bit.CFG_CRC_SEC_FAULT = report_fault_on_nFLT1;
	ucc5870[UL].cfg9.bit.INT_COMM_SEC_FAULT = report_comm_fault_on_nFLT1;
	ucc5870[UL].cfg9.bit.GD_TSD_FAULT = report_fault_on_nFLT1;
	ucc5870[UL].cfg9.bit.PS_TSD_FAULT = dont_report_TSD_on_nFLT1;
	ucc5870[UL].cfg9.bit.OVLO23_FAULT = report_fault_on_nFLT1;
	ucc5870[UL].cfg9.bit.UVLO23_FAULT = report_fault_on_nFLT1;
	ucc5870[UL].cfg9.bit.GM_FAULT = GM_FAULT_ON_nFLT1;  //GM_FAULT_IGNORE;  //
	ucc5870[UL].cfg9.bit.OC_FAULT = dont_report_fault_on_nFLT1;
	ucc5870[UL].cfg9.bit.SC_FAULT = report_fault_on_nFLT1;

	//
	// CFG10 register settings
	//
	ucc5870[UL].cfg10.bit.FS_STATE_INT_COMM_SEC = PULLED_LOW;
	ucc5870[UL].cfg10.bit.FS_STATE_GM = PULLED_LOW;
	ucc5870[UL].cfg10.bit.FS_STATE_GD_TSD = PULLED_LOW;
	ucc5870[UL].cfg10.bit.FS_STATE_PS_TSD = NO_ACTION;
	ucc5870[UL].cfg10.bit.FS_STATE_OCP = NO_ACTION;
	ucc5870[UL].cfg10.bit.FS_STATE_INT_REG_FAULT = PULLED_LOW;
	ucc5870[UL].cfg10.bit.FS_STATE_DESAT_SCP = PULLED_LOW;
	ucc5870[UL].cfg10.bit.GD_TWN_SEC_EN = GD_TWN_SEC_ENABLED;

	//
	// CFG11 register settings
	//
	ucc5870[UL].cfg11.bit.FS_STATE_CLK_MON_SEC_FAULT = PULLED_LOW;
	ucc5870[UL].cfg11.bit.VCE_CLMP_HLD_TIME = VCE_CLAMP_HOLD_TIME_100ns;
	ucc5870[UL].cfg11.bit.FS_STATE_CFG_CRC_SEC_FAULT = PULLED_LOW;
	ucc5870[UL].cfg11.bit.FS_STATE_TRIM_CRC_SEC_FAULT = PULLED_LOW;
	ucc5870[UL].cfg11.bit.FS_STATE_OVLO3 = PULLED_LOW;
	ucc5870[UL].cfg11.bit.FS_STATE_UVLO3 = PULLED_LOW;
	ucc5870[UL].cfg11.bit.FS_STATE_OVLO2 = PULLED_LOW;
	ucc5870[UL].cfg11.bit.FS_STATE_UVLO2 = PULLED_LOW;

	//
	// ADCCFG register settings
	//
	ucc5870[UL].adccfg.bit.ADC_ON_CH_SEL_7 = DONT_SAMPLE_CH;
	ucc5870[UL].adccfg.bit.ADC_ON_CH_SEL_6 = DONT_SAMPLE_CH;
	ucc5870[UL].adccfg.bit.ADC_ON_CH_SEL_5 = DONT_SAMPLE_CH;
	ucc5870[UL].adccfg.bit.ADC_ON_CH_SEL_4 = DONT_SAMPLE_CH;
	ucc5870[UL].adccfg.bit.ADC_ON_CH_SEL_3 = DONT_SAMPLE_CH;
	ucc5870[UL].adccfg.bit.ADC_ON_CH_SEL_2 = DONT_SAMPLE_CH;
	ucc5870[UL].adccfg.bit.ADC_ON_CH_SEL_1 = DONT_SAMPLE_CH;
	ucc5870[UL].adccfg.bit.ADC_OFF_CH_SEL_7 = DONT_SAMPLE_CH;
	ucc5870[UL].adccfg.bit.ADC_OFF_CH_SEL_6 = DONT_SAMPLE_CH;
	ucc5870[UL].adccfg.bit.ADC_OFF_CH_SEL_5 = DONT_SAMPLE_CH;
	ucc5870[UL].adccfg.bit.ADC_OFF_CH_SEL_4 = DONT_SAMPLE_CH;
	ucc5870[UL].adccfg.bit.ADC_OFF_CH_SEL_3 = DONT_SAMPLE_CH;
	ucc5870[UL].adccfg.bit.ADC_OFF_CH_SEL_2 = DONT_SAMPLE_CH;
	ucc5870[UL].adccfg.bit.ADC_OFF_CH_SEL_1 = DONT_SAMPLE_CH;

	//
	// DOUTCFG register settings
	//
	ucc5870[UL].doutcfg.bit.DOUT_TO_AI1 = DONT_CONNECT_TO_DOUT;
	ucc5870[UL].doutcfg.bit.DOUT_TO_AI3 = DONT_CONNECT_TO_DOUT;
	ucc5870[UL].doutcfg.bit.DOUT_TO_AI5 = DONT_CONNECT_TO_DOUT;
	ucc5870[UL].doutcfg.bit.DOUT_TO_AI2 = DONT_CONNECT_TO_DOUT;
	ucc5870[UL].doutcfg.bit.DOUT_TO_AI4 = DONT_CONNECT_TO_DOUT;
	ucc5870[UL].doutcfg.bit.DOUT_TO_AI6 = DONT_CONNECT_TO_DOUT;
	ucc5870[UL].doutcfg.bit.DOUT_TO_TJ = DONT_CONNECT_TO_DOUT;
	ucc5870[UL].doutcfg.bit.FREQ_DOUT = FREQ_DOUT_111p4KHz;
	ucc5870[UL].doutcfg.bit.AI6OCSC_EN = PROT_DISABLED;
	ucc5870[UL].doutcfg.bit.AI4OCSC_EN = PROT_DISABLED;
	ucc5870[UL].doutcfg.bit.AI2OCSC_EN = PROT_DISABLED;
	ucc5870[UL].doutcfg.bit.AI5OT_EN = PROT_DISABLED;
	ucc5870[UL].doutcfg.bit.AI3OT_EN = PROT_DISABLED;
	ucc5870[UL].doutcfg.bit.AI1OT_EN = PROT_DISABLED;
...
UCC5870_Status_e Init_UCC5870() {
	...
	//
	// Setup PWM pins (UH, UL, VH, VL, WH and WL) as PWM timer outputs
	//
	for (uint16_t i = 0; i < DRIVER_NUM; i++) {
		GPIO_InitTypeDef GPIO_InitStruct = { 0 };
		GPIO_InitStruct.Pin = PWM_pins[i].pin;
...
// =============================================================================
// Get address of driver being diagnosed
...
// =============================================================================
// Print STATUS1 register to UART
...
// =============================================================================
// Print STATUS2 register to UART
...
// =============================================================================
// Print STATUS3 register to UART
...
// =============================================================================
// Print STATUS4 register to UART
...
// =============================================================================
// Print STATUS5 register to UART
...
// =============================================================================
// Print values of STATUS registers to UART
